            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{URL::asset('assets/img/6606-male-user.png')}}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
                    ...
                    </svg><span class="side-menu__label">قائمة الفواتير</span><i
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    @endcan
                    @can('تقرير العملاء')
                    <li><a class="slide-item" href="{{ url('/' . $page='customers_report') }}">تقرير العملاء</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
                    ...
                    </svg><span class="side-menu__label">قائمة الاعدادات</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
