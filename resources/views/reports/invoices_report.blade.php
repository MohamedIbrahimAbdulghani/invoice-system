    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="pb-0 card-header">
                ...
                <form action="{{ route('invoices_report.Search_invoices') }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('invoices_details') }}/{{ $invoice->id }}">{{$invoice->sections->section_name}}</a>
                                        </td>
